...
var actions = {
    ...
    deleteNHAsset: function deleteNHAsset(_ref12, params) {
        ...
        var callback, itemId, NHAssetIds, _params$onlyGetFee2, onlyGetFee, overLimit, nhs_res, operations;
        ...
        return _regenerator2.default.async(function deleteNHAsset$(_context9) {
            while (1) {
                switch (_context9.prev = _context9.next) {
                    case 0:
                        _helper2.default.trimParams(params);
                        callback = params.callback, itemId = params.itemId, NHAssetIds = params.NHAssetIds, _params$onlyGetFee2 = params.onlyGetFee, onlyGetFee = _params$onlyGetFee2 === undefined ? false : _params$onlyGetFee2;
    ...
    creatNHAssetOrder: function creatNHAssetOrder(_ref17, params) {
        ...
        var otc_account_id, orderFee, NHAssetId, _params$memo, memo, price, _params$priceAssetId, priceAssetId, _params$expiration, expiration, _params$onlyGetFee3, onlyGetFee, nhs_res;
